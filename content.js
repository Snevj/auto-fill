...
(() => {
  ...
  const RULES = [
    ...
    { key: "address", re: /street\s*address|\baddress(\s*line\s*1)?\b/i, get: (p) => p.personal.address1 },
    { key: "city", re: /\bcity\b|\btown\b/i, get: (p) => p.personal.city },
    { key: "state", re: /\bstate\b|\bprovince\b/i, get: (p) => p.personal.state },
    { key: "zip", re: /\bzip\b|postal/i, get: (p) => p.personal.zip },
    { key: "country", re: /\bcountry\b/i, get: (p) => p.personal.country },
